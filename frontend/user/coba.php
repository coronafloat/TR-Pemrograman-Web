...
<body class="bg-[#F1F0E8]">
    ...
    <nav class="bg-white shadow-md py-2 sticky top-0">
        <div class="max-w-screen-xl mx-auto px-6 flex items-center justify-between">
            ...
            <div class="md:flex items-center space-x-6">
                ...
                <!-- Button Login -->
                <button class="flex items-center border-2 border-black bg-white text-black font-medium rounded-lg px-4 py-2 hover:bg-[#dedede] transition duration-300"
                    onclick="window.location.href='../../frontend/admin/main.php';">
                    Log in
                </button>
                <!-- Button Sign Up -->
                <button class="flex items-center bg-black text-white font-medium rounded-lg px-4 py-2 hover:bg-[#3E4143] transition duration-300">
                    Sign up
                </button>
            </div>
        </div>
    ...
    <section class="bg-[url('assets/belajar-mobil3.jpg')] bg-cover bg-center bg-no-repeat mt-1/2">
        ...
        <div class="flex items-center justify-center text-white flex-col">
            ...
            <button class="flex items-center bg-[#E5E1DA] text-black font-medium rounded-lg px-4 py-2 hover:bg-[#3E4143] hover:text-[#D8D2C2] transition duration-300 mt-8">
                Gabung Kursus
            </button>
        </div>
        </div>
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden w-64">
        ...
        <div class="p-4">
            ...
            <p class="text-gray-600 mt-2">
                Ikuti kursus mengemudi mobil bersama instruktur berpengalaman. Belajar teknik mengemudi yang aman dan profesional untuk perjalanan sehari-hari.
            </p>
            <button class="mt-4 bg-[#E5E1DA] text-black font-medium rounded-lg px-4 py-2 hover:bg-[#3E4143] hover:text-[#D8D2C2] transition duration-300">
                Learn More
            </button>
        </div>
    </div>
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden w-64">
        ...
        <div class="p-4">
            ...
            <p class="text-gray-600 mt-2">Pelajari cara mengemudi motor dengan aman, menguasai teknik belok, rem, dan manuver lainnya dengan pengajaran langsung dari instruktur berlisensi.</p>
            <button class="mt-4 bg-[#E5E1DA] text-black font-medium rounded-lg px-4 py-2 hover:bg-[#3E4143] hover:text-[#D8D2C2] transition duration-300">
                Learn More
            </button>
        </div>
